...
print_string "Test 8: Zero power or zero power?? (Faggot test)\n"
let a = 0;;
let b = 0;;
let res = powerG a b in
let res2 = int_of_peano(power (peano_of_int a) (peano_of_int b)) in
...
print_string "Test 12: Spoon into your eye or...?\n"
let a = 23;;
let b = 564;;
let c = 111;;
let d = 567;;
...
if (res <> res2) then print_string ("Failed. Expected: " ^ string_of_int(res) ^ ". Found: " ^ string_of_int(res2) ^ ". You're not a real G you're Wanksta nigga.\n")
else print_string "You're real Gangsta. Congrats!\n";;
print_string "_________________________\n";;
